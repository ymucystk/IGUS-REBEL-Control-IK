...
export default function Home() {
  ...
  React.useEffect(() => {
    ...
    const get_all_rotate = (final_target,wrist_direction,wrist_angle)=>{
      ...
      console.log(`p16_pos:{x:${p16_pos.x}, y:${p16_pos.y}, z:${p16_pos.z}}`)
...
const Assets = ()=>{
  return (
    <a-assets>
      ...
      <a-asset-items id="j1" src="igus_REBEL_j0.gltf" ></a-asset-items>
      <a-asset-items id="j2" src="igus_REBEL_j1.gltf" ></a-asset-items>
      <a-asset-items id="j3" src="igus_REBEL_j2.gltf" ></a-asset-items>
      <a-asset-items id="j4" src="igus_REBEL_j3.gltf" ></a-asset-items>
      <a-asset-items id="j5" src="igus_REBEL_j4.gltf" ></a-asset-items>
      <a-asset-items id="j6" src="igus_REBEL_j5.gltf" ></a-asset-items>
    </a-assets>
  )
}
